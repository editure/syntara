<div class="navbar main-bar navbar-default">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="{{ (!empty($siteUrl)) ? $siteUrl : '/'}} " target="_new">
            ...
            <div class="visible-sm"><img class="ajax-loader ajax-loader-sm" src="{{ secure_asset('packages/mrjuliuss/syntara/assets/img/ajax-load.gif') }}" style="float: right;"/></div>
        </a>
    </div>
    ...
    <div class="navbar-collapse collapse navbar-responsive-collapse">
        ...
        <ul class="nav navbar-nav navbar-{{ (Config::get('syntara::config.direction') === 'rtl') ? 'left' : 'right' }}">
            <li class="hidden-sm"><img class="ajax-loader ajax-loader-lg" src="{{ secure_asset('packages/mrjuliuss/syntara/assets/img/ajax-load.gif') }}" style="float: right;"/></li>
